    ...
    <div className="flex flex-col lg:flex-row min-h-screen">
      ...
      <div className="flex w-full flex-col items-center justify-center bg-card px-4 py-8 sm:px-8 sm:py-12 lg:w-[30%] lg:min-w-[420px]">
        ...
        <div className="w-full max-w-sm">
          ...
          <button
            type="button"
            className="flex w-full items-center justify-center gap-2.5 rounded-lg border border-input-border bg-input-bg py-2.5 text-sm font-medium text-text-primary hover:bg-card-hover transition"
          >
